...
// Website: https://www.rubenmartinezes.com/software
//
...
input int Stop_Loss   = 162; // Stop Loss (pips)
input int Take_Profit = 144; // Take Profit (pips)
static input string Ind1 = "------------";// ----- Bollinger Bands -----
input int Ind1Param0 = 28; // Period
input double Ind1Param1 = 2.51; // Deviation

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 74202727; // Magic Number
...
int sessionSundayOpen           = 7200;  // 02:00
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Darwinex-Demo; GBPNZD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":162,"takeProfit":144,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"On Balance Volume","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[3,3,0,0,0],"numValues":[28,2.51,0,0,0,0]}]} */
